...
We run lean and ship often. As a PM here, your decisions have direct product impact — no layers of bureaucracy, just you, the team, and the problem to solve. You will work with engineers who care deeply about delivery quality.`
  ...
  candidates: [
    ...
    // Candidates matching JobApplicationsPage rows 1–6
    {
      ...
      experiences: [{ id: 1, company: 'MindInventory', designation: 'React Developer', from: '2022-Jan', to: 'Present', isCurrent: true, description: 'Developing core product features.' }],
      gender: 'Male',
    ...
    },
    {
      ...
      experiences: [{ id: 1, company: 'DesignCo', designation: 'UI/UX Designer', from: '2020-Mar', to: 'Present', isCurrent: true, description: 'Leading end-to-end UI design for SaaS products.' }],
      gender: 'Female',
    ...
    },
    {
      ...
      experiences: [{ id: 1, company: 'FlutterApps', designation: 'Flutter Developer', from: '2021-Jul', to: 'Present', isCurrent: true, description: 'Building cross-platform apps.' }],
      source: 'LinkedIn',
      businessUnit: 'MindInventory',
      recordOwner: 'Sarah Chen',
      candidateStatus: 'Active' as const,
    ...
    },
    {
      ...
      totalExperienceYears: 3,
      totalExperienceMonths: 0,
      experiences: [{ id: 1, company: 'BizAnalytics', designation: 'Business Analyst', from: '2019-Feb', to: 'Present', isCurrent: true, description: 'Analyzing market trends and client requirements.' }],
      source: 'Naukri',
      businessUnit: 'MindInventory',
      recordOwner: 'Michael Park',
      candidateStatus: 'Active' as const,
    ...
    },
    {
      ...
      experiences: [{ id: 1, company: 'ProjMasters', designation: 'Project Manager', from: '2018-Aug', to: 'Present', isCurrent: true, description: 'Managing enterprise software delivery.' }],
      source: 'CollabCRM',
      businessUnit: '300Mind',
      recordOwner: 'Sarah Chen',
      candidateStatus: 'Active' as const,
    ...
    },
    {
      ...
      currentDesignation: '2D Artist',
      noticePeriod: 'Immediate joiner',
      skills: ['Illustrator', 'Photoshop', 'After Effects'],
      totalExperienceYears: 1,
      totalExperienceMonths: 8,
      experiences: [{ id: 1, company: 'ArtStudio', designation: '2D Artist', from: '2022-Nov', to: 'Present', isCurrent: true, description: 'Creating game and app assets.' }],
      source: 'Referral',
      businessUnit: 'MindInventory',
      recordOwner: 'Michael Park',
      candidateStatus: 'Active' as const,
