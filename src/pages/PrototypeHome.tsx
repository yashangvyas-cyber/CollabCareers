...
const flows = [
  ...
  },
  {
    ...
    description: 'The invite & cancellation emails an external panelist receives — each opens their secure, login-free interview page where every other state is reached by using the flow.',
    screens: [
      { label: 'Invite (Online)', path: '/panel-email/ext-invited', badge: 'Online' },
      { label: 'Invite (Offline)', path: '/panel-email/ext-offline', badge: 'Offline' },
      { label: 'Cancelled Invitation', path: '/panel-email/ext-cancelled', badge: 'Cancelled' },
    ],
